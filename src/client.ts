...
import type { Callback, Client, ClientRequestOptions, FormValue, ValidationTargets  } from './types'
import {
  buildSearchParams,
  deepMerge,
  mergePath,
...
class ClientRequestImpl {
  ...
  fetch = async (
    ...
    const headers = headerValues ?? undefined
    let url = this.url
    ...
    return (opt?.fetch || wxFetch)(url, {
      body: setBody ? this.rBody as any : undefined,
